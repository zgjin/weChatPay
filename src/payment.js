...
function Payment(config) {var _this = this;(0, _classCallCheck3.default)(this, Payment);this.
  ...
  getReadyPayParams = function () {var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(order) {var 
      ...
      payParams;return _regenerator2.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:console.log('getReadyPayParams.params', order);default_params = { out_trade_no: 'XSDX' + _util2.default._generateTimeStamp(), // 商户订单号XSDX+'时间戳'
              ...
              packageVal = 'Sign=WXPay';if (params.trade_type === 'JSAPI') {packageVal = 'prepay_id=' + data.prepay_id;}payParams = Object.assign({}, { appid: data.appid || _this.config.appid, partnerid: _this.config.mch_id, prepay_id: data.prepay_id, timeStamp: _util2.default._generateTimeStamp(), nonce_str: _util2.default._generateNonceStr(), 
                package: packageVal });
